...
Persist p{PERSIST_MAGIC, PERSIST_VERSION, absenceOffMs, restoreWindowMs, 0};
...
mapping = (int*)malloc(sizeof(int)LED_ROWSLED_COLS);
...
if(t-gLastSpawn>RIPPLE_PERIOD_MS||baseR<-100.0f){gLastSpawn=t;baseR=0.0f;}
